...
```json
{
  ...
  "erreurs_typiques": [
    { "texte": "La laïcité interdit les religions", "frequence_reelle": 0.7 },
    { "texte": "La laïcité = athéisme d'État", "frequence_reelle": 0.4 }
  ],
...
| `frequence_reelle` | Initialisée par estimation, mise à jour par les données réelles |
...
### 1.4 Entité `EtatNotion` (stockée dans le navigateur)
...
>
> ```
> Lis SPECIFICATION.md, section 1.4 et 1.5.
>
...
>   le critère d'acquisition de la section 1.5
...
**Affiché à la place :**
Descriptif, vrai, non anxiogène. Le critère d'acquisition (§1.5) est directement l'interface.
...
Le chiffre vient de `frequence_reelle`. L'erreur devient **information partagée**, pas déficit personnel.
